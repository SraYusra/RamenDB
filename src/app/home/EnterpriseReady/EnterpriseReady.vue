    ...
    <vue-grid>
      <vue-grid-row>
        <vue-grid-item fill class="vueGridItem">
          <vue-headline level="2">Services</vue-headline>
        </vue-grid-item>
        <vue-grid-item class="vueGridItem">
          <vue-card class="vueCard">
            <vue-card-body>
              <vue-icon-chart-line />
              <vue-headline level="3">Consultation</vue-headline>
              <p>
        ...
        <vue-grid-item class="vueGridItem">
          <vue-card class="vueCard">
            <vue-card-body>
              ...
              <vue-headline level="3">OWL Support</vue-headline>
              <p>
        ...
        <vue-grid-item class="vueGridItem">
          <vue-card class="vueCard">
            <vue-card-body>
              <vue-icon-flag />
              <vue-headline level="3">Audio Room</vue-headline>
              <p>
