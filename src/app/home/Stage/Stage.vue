    ...
    <vue-grid>
      <vue-grid-row>
        <vue-grid-item class="vueGridItem">
          <vue-headline level="1" :class="$style.title">Ramen Database</vue-headline>
          <div :class="$style.subTitle">
            {{
              ...
              'The most complete database tool for office reporting. With focus on performance, efficiency, and user experience.'
            }}
          </div>
